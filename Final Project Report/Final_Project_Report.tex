...
\begin{document}
	...
	\begin{figure}[h]
		\centering
		\includegraphics[width=14cm, height=17.6cm]{"Final Project".pdf}% no need to explicitly specify the file extension
	...
	{
		\scriptsize
		\verbatiminput{Instructionmemoryset3.txt}
	}
	...
	\begin{figure}[h]
		...
		\caption{Simulated Waveform for Testbench 1}
	\end{figure}
